...
- [Traducción del problema de negocio a un problema de Machine Learning.](https://github.com/EuniceGarcia503/FlightOnTime-DS/blob/main/docs/04_metodolog%C3%ADa_problema_ml.ipynb)  
